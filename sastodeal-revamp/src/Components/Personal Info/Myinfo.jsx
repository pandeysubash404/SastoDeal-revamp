...
function Myinfo(props) {
  ...
  console.log("Section: ", props.info);
  ...
  return (
    <div>
      ...
      <div className="flex justify-between  mt-3 mb-3">
        <h2 className="text-[#3C4242] font-bold text-xl">
          {user.firstname} {user.lastname}
        </h2>
        <h2 className="text-[#3C4242] font-bold text-xl flex justify-end ">
          Change
        </h2>
      </div>
      <div>
      ...
      <div className=" mt-3 mb-3">
        ...
        <div className="flex justify-between">
          <h2 className="text-[#3C4242] font-bold text-lg">{user.email}</h2>
          <h2 className="text-[#3C4242] font-bold text-lg flex justify-end ">
            Change
          </h2>
        </div>
      </div>
      ...
      <div className=" mt-3 mb-3">
        ...
        <div className="flex justify-between ">
          <h2 className="text-[#3C4242] font-bold text-lg">{user.phone}</h2>
          <h2 className="text-[#3C4242] font-bold text-lg flex justify-end ">
            Change
          </h2>
        </div>
      ...
      <div className="flex gap-10 mt-5">
        <div className="bg-[#F6F6F6] p-4 rounded shadow-md ">
          ...
          <div className="flex gap-10 mt-10">
            <button className="text-[#807D7E] px-3 py-2 border border-[#807D7E] border-1000 rounded-lg">
              Home
            </button>
            <button className="text-[#807D7E] px-6 py-2 border border-[#807D7E] border-1000 rounded-lg">
